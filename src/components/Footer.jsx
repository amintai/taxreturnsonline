  ...
  return (
    <div className="mt-24 pt-12 pb-8 bg-[#F8F9FA]">
      <div className="container mb-12 text-center sm:text-left grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          <h6 className="font-medium text-xl mb-4 text-[#003366]">Resources</h6>
          <Link text="About Us" />
          <Link text="Blog" />
          <Link text="Contact" />
          <Link text="FAQ" />
        ...
        <div>
          <h6 className="font-medium text-xl mb-4 text-[#003366]">
            Legal Stuff
          </h6>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-9 border border-[#BCD0E5] rounded-md text-left">
            <input
              className="w-full p-2 bg-transparent outline-none border border-[#003366] rounded-md"
              type="tel"
              placeholder="Enter your phone Number"
            />
          </div>
          <button className="primary-button mt-6 bg-[#003366] text-white hover:bg-[#026a66] transition duration-200">
            Sign up Now
          </button>
        </div>
      </div>
...
export function Link({ text }) {
  return (
    <p className="cursor-pointer mt-2 text-[#22343D] hover:text-[#003366] transition duration-200">
      {text}
    </p>
  );
}
