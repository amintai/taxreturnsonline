    ...
    <section className="py-8 px-4 max-w-6xl mx-auto text-left">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="md:w-1/2">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Need Help with Annual Compliance & Filing?</h2>
          <p className="text-gray-600 mb-4">Fill Up the below Mentioned Form</p>
          <p className="text-gray-700 mb-4">
            The Companies Act, 2013 of Indian Govt. legally mandates every entity in the country to
            follow the declarations of the Annual Compliance. For the Private Limited Companies
            (Pvt. Ltd.), One Person Companies (OPC), or Limited Liability Partnerships (LLP), Annual
            Compliance acts as a regular update to the Govt. that the entity is conducting its business
            under the particular Act.
          </p>

          <div className="bg-green-600 p-4 rounded-md mb-4">
            <h3 className="text-lg font-semibold text-white mb-2">Benefits of Filing from Online Legal India™</h3>
          </div>
          <ul className="list-disc ml-5 mb-6 space-y-1 text-gray-700">
            ...
            <li>25+ Experienced chartered accountants are ready to serve you</li>
          </ul>

          <div className="bg-green-600 p-4 rounded-md mb-4">
            <h3 className="text-lg font-semibold text-white mb-2">Why Choose Us for Your Annual Compliance?</h3>
          </div>
          <ul className="list-disc ml-5 mb-6 space-y-1 text-gray-700">
            <li>25+ highly experienced chartered accountants are ready to serve you</li>
        ...
        <div className="md:w-1/2 bg-white shadow-md rounded-md p-6 border border-gray-200">
          <form onSubmit={handleSubmit} className="space-y-4">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Need Help with Annual Compliance & Filing?
</h2>
            <div>
              <label htmlFor="companyType" className="block text-sm font-medium text-gray-700 mb-1">Type of Company <span className="text-red-500">*</span></label>
              <select
                id="companyType"
                name="companyType"
                required
            ...
            <div>
              <label htmlFor="annualTurnover" className="block text-sm font-medium text-gray-700 mb-1">Annual Turnover Range <span className="text-red-500">*</span></label>
              <select
                id="annualTurnover"
                name="annualTurnover"
                required
            ...
            <div className="flex items-start py-2">
              ...
              />
              <label htmlFor="termsAccepted" className="ml-2 block text-sm text-gray-600">
