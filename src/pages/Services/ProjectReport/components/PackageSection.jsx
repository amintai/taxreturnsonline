        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 max-w-4xl mx-auto">
          ...
          <div className="md:w-1/2">
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
              <div className="bg-green-600 text-white py-3 px-4 rounded-t-lg mb-4">
              ...
              <button className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-md">
                Request a Call Back
              </button>
            </div>
          </div>
