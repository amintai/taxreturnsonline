      ...
      <div className="p-5">
        {done ? (
          <div className="text-center py-6 space-y-3">
            ...
            <button onClick={() => setDone(false)} className="text-xs text-blue-600 hover:underline">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 text-sm border rounded-lg outline-none transition focus:ring-2 ${errors.name ? "border-red-400 focus:ring-red-100 bg-red-50" : "border-gray-200 focus:ring-blue-100 focus:border-blue-400"}`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 text-sm border rounded-lg outline-none transition focus:ring-2 ${errors.mobile ? "border-red-400 focus:ring-red-100 bg-red-50" : "border-gray-200 focus:ring-blue-100 focus:border-blue-400"}`}
              />
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2.5 text-sm border rounded-lg outline-none transition focus:ring-2 bg-white ${errors.state ? "border-red-400 focus:ring-red-100" : "border-gray-200 focus:ring-blue-100 focus:border-blue-400"}`}
              >
