...
const ItrApplicationForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('ITR Form submitted successfully!');
  };

  return (
    <div className="bg-white rounded-md shadow-md p-6 max-w-md mx-auto">
      <h2 className="text-xl font-semibold mb-4">Apply for Income Tax Return Filing</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-start space-x-2">
          ...
          <label htmlFor="terms" className="text-sm">
            I agree to the Terms and Conditions, and consent to receive updates and communication.
          </label>
        </div>
