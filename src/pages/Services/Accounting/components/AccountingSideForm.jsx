...
import { MessageCircle, User, Smartphone, MapPin, Briefcase } from 'lucide-react';
...
const AccountingSideForm = () => {
  const [form, setForm] = useState({ name: '', mobile: '', state: '', service: '', terms: false });
  ...
  const handleSubmit = (e) => {
    ...
    setDone(true);
    setForm({ name: '', mobile: '', state: '', service: '', terms: false });
  };
      ...
      <div className="p-5">
        {done ? (
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              <label className="flex items-center gap-1.5 text-sm font-medium text-gray-700 mb-1">
                <Briefcase size={14} className="text-gray-400" /> Service Needed
...
export default AccountingSideForm;
