...
const IecDocuments = () => (
  <div>
    <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Documents Required</h2>
    <div className="w-12 h-1 bg-[#005C9D] mb-5" />
    <p className="text-gray-500 text-sm mb-6">Keep these ready before we begin the application</p>
