                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 my-8">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Available in 6 Languages including English</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">over Call, E-mail, Chat Support</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">+ Encrypted Company Incorporation Process</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="font-semibold mb-2">India's most efficient CA panel</h3>
                            <p className="text-sm text-gray-600">ready to assist along the way</p>
                        </div>
                    </div>

                    <div className="mt-8 p-4 bg-yellow-50 border-l-4 border-yellow-400 text-sm">
                        <p>*Once you are Ready to Setup your Dream Company, you'll receive Rs 999 adjustment from your selected company registration package from us</p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Protects personal assets from business liabilities</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Registered companies enjoy greater market trust</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Company continues regardless of changes in ownership</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Easier access to loans and investor funding</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Various tax advantages available to registered companies</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Easier to expand internationally as a registered entity</p>
                            </div>
                        </div>
                    </div>
                </div>
